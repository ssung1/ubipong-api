...
public class TestChallongeMatchWrapperList {
    ...
    public void testDeserializeMatchWrapperList() throws Exception {
        ...
        ChallongeMatch firstMatch = list.get(0).getChallongeMatch();
